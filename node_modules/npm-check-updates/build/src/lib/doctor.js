...
const npm = (args, options, print) => {
    ...
    return (options.packageManager === 'yarn' ? yarn_1.default : npm_1.default)(args, options, spawnOptions);
};
...
const loadPackageFile = async (options) => {
    ...
    // assert package.json
    try {
        pkgFile = fs_1.default.readFileSync('package.json', 'utf-8');
...
const doctor = async (run, options) => {
    ...
    let lockFile = '';
    try {
        lockFile = fs_1.default.readFileSync(lockFileName, 'utf-8');
    }
    catch (e) { }
    ...
    try {
        ...
        fs_1.default.writeFileSync('package.json', pkgFile);
        if (lockFile) {
            fs_1.default.writeFileSync(lockFileName, lockFile);
        }
        else {
        ...
        for (const [name, version] of Object.entries(upgrades)) {
            ...
            try {
                ...
                lastPkgFile = (await (0, upgradePackageData_1.default)(lastPkgFile, { [name]: allDependencies[name] }, { [name]: version }, {}, { ...options, interactive: false })).newPkgData;
                ...
                if (options.packageManager === 'yarn') {
                    fs_1.default.writeFileSync('package.json', lastPkgFile);
                }
            }
        }
