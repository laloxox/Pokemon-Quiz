 ...
 */
export declare function viewMany(packageName: string, fields: string[], currentVersion: Version, { registry, timeout, retry }?: ViewOptions, retryed?: number, npmConfigLocal?: Index<string | boolean>): Promise<Packument>;
